...
function displayResults(json) {
  ...
  if (neo.length == 0) {
    ...
    for (let i = 0; i < neo.length; i++) {
      ...
      li.appendChild(document.createTextNode('Closest Approach: ' + currentNEO.closest_approach));
      list.appendChild(li);
      li = document.createElement('li');
      li.appendChild(document.createTextNode('Relative Velocity: ' + currentNEO.relative_velocity));
      list.appendChild(li);
      li = document.createElement('li');
      li.appendChild(document.createTextNode('Orbiting Body: ' + currentNEO.orbiting_body));
      list.appendChild(li);
      li = document.createElement('li');
      li.appendChild(document.createTextNode('Minimum Diameter: ' + currentNEO.diameter_min));
      list.appendChild(li);
      li = document.createElement('li');
      li.appendChild(document.createTextNode('Maximum Diameter: ' + currentNEO.diameter_max));
      list.appendChild(li);
      li = document.createElement('li');
